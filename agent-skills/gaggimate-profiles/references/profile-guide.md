# Gaggimate Profile Creation Guide - Complete Reference

## Overview

This document provides comprehensive guidance for creating custom espresso extraction profiles for Gaggimate-equipped machines. Gaggimate supports two profile types: **Simple** and **Pro**, with Pro profiles offering advanced features like pressure profiling, flow control, and complex transitions.

### Supported Machines

- **Gaggia Classic** (1991-2014)
- **Gaggia Classic Pro / Evo** (2019 - present)
- **Rancilio Silvia**
- **DeLonghi ECP** (community contribution)
...
- Created for personal reference and profile generation
- Based on Gaggimate firmware v1.6.0+ official documentation
- Includes examples from Santa Rosa and Amizade dialing sessions
- Informed by official docs at https://docs.gaggimate.eu/

---

*This guide was created for personal use, combining official Gaggimate documentation with hands-on experience. For official technical support, see https://docs.gaggimate.eu/ or join the Discord: https://discord.gg/APw7rgPGPf*
